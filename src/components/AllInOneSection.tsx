...
const AllInOneSection = () => {
  return (
    <section className='w-full hidden  lg:flex justify-center bg-white dark:bg-white px-4 py-14'>
      <div className='w-[1420px] h-[416px] bg-[#014421] rounded-[24px] flex flex-col md:flex-row items-center justify-between relative overflow-hidden px-[52px] py-[52px]'>
        ...
        {/* Right: Phone */}
        <div className='absolute right-[-40px] bottom-[-10px] z-0 hidden md:block ipadpro:hidden'>
          <img
